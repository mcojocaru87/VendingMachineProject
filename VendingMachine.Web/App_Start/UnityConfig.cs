...
namespace VendingMachine.Web.App_Start
{
    /// <summary>
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IInventoryService, InventoryService>(new PerRequestLifetimeManager());
            ...
            container.RegisterType<ITrayRepository, TrayRepository>(new PerRequestLifetimeManager());
            container.RegisterType<ITrayService, TrayService>(new PerRequestLifetimeManager());
